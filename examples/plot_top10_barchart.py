...
df = pd.melt(df, id_vars=['Identifiant', 'Nom_Etablissement_x', 'LLX', 'LLY', 'Regions'],
    var_name='Annee', value_name='Quantite')
...
ani = animation.FuncAnimation(fig, plot_top10_barchart, frames=range(2003, 2018), interval=1500,
                              fargs=[df,"Quantite","Annee","Regions",'Nom_Etablissement_x',
